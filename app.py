...
def generate_dataset (n =5000 ):
    ...
    for _ in range (n ):
        ...
        income =np .random .randint (60000 ,6000000 )
        loan_amount =np .random .randint (10000 ,2000000 )
        ...
        if cat =="farmer":
            ...
            cibil_needed =550 if dpiit_reg else 600 
            eligible =int (
            age >=21 
            ...
            gst_turnover_threshold =2000000 
            ...
            gst_turnover_threshold =4000000 
            gst_required =int (turnover >=gst_turnover_threshold )
            gst_ok =(gst_filed ==1 )if gst_required else True 

            cibil_needed =620 if udyam_reg else 680 
            eligible =int (
            business_age >=1 
            and cibil >=cibil_needed 
            and gst_ok 
